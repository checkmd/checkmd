...
with open('app/environment.json') as f:
    env = json.load(f)
...
DATABASES = {
    'default': {
        ...
        'NAME': env['CHECKMD_DATABASE_NAME'],                      
        'USER': env['CHECKMD_DATABASE_USER'],
        'PASSWORD': env['CHECKMD_DATABASE_PASSWORD'],
        'HOST': env['CHECKMD_DATABASE_HOST'],
        'PORT': env['CHECKMD_DATABASE_PORT'],                      
    }
}
